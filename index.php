	...
	<body>
		<!-- Header -->
			<section id="header" class="dark">
				<header>
					<h1>Velkommen til VolzPlay!</h1>
					<p>En moddet Minecraft server for deg som liker utfordringer og teknologi rettete modder.</p>
				</header>
				<footer>
					<a href="#first" class="button scrolly">Finn ut mer</a>
				</footer>
			</section>
		...
		<!-- First -->
			<section id="first" class="main">
				<header>
					<div class="container">
						...
						<p>For å kunne spille på vår server må du laste ned vår <a href="#launcher">launcher</a>, og du må spørre "halvorshalvors" for at du skal komme på vår whitelist.</p>
					</div>
				</header>
			...
			<section id="rules" class="main">
				<header>
					<div class="container">
						<h2>Regler</h2>
						<p>Les nøye igjennom og godta reglene. Nye regler kan komme underveis.</p>
					</div>
				</header>
		...
		<!-- Footer -->
			<section id="footer">
				...
				<div class="copyright">
					<ul class="menu">
						<li>Kopirett &copy; <?php echo date('Y'); ?> VoltzPlay!</li>
					</ul>
				</div>
			</section>
